  ...
  public LessonPlanDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfLessonPlanEntity = new EntityInsertionAdapter<LessonPlanEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `lesson_plan_table` (`planId`,`title`,`lessonType`,`keyPoints`,`difficulties`,`contentMarkdown`,`blocksJson`,`targetClassName`,`relatedKnowledgeNodeId`,`createdAt`,`updatedAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getLessonType() == null) {
          statement.bindNull(3);
        } else {
          statement.bindString(3, entity.getLessonType());
        }
        ...
        if (entity.getDifficulties() == null) {
          statement.bindNull(5);
        } else {
          statement.bindString(5, entity.getDifficulties());
        }
        if (entity.getContentMarkdown() == null) {
          statement.bindNull(6);
        } else {
          statement.bindString(6, entity.getContentMarkdown());
        }
        ...
        if (entity.getTargetClassName() == null) {
          ...
          statement.bindString(8, entity.getTargetClassName());
        }
        if (entity.getRelatedKnowledgeNodeId() == null) {
          statement.bindNull(9);
        } else {
          statement.bindString(9, entity.getRelatedKnowledgeNodeId());
        }
    ...
    this.__updateAdapterOfLessonPlanEntity = new EntityDeletionOrUpdateAdapter<LessonPlanEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `lesson_plan_table` SET `planId` = ?,`title` = ?,`lessonType` = ?,`keyPoints` = ?,`difficulties` = ?,`contentMarkdown` = ?,`blocksJson` = ?,`targetClassName` = ?,`relatedKnowledgeNodeId` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `planId` = ?";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getPlanId() == null) {
          ...
          statement.bindString(12, entity.getPlanId());
        }
      }
    };
  }
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"lesson_plan_table"}, new Callable<List<LessonPlanEntity>>() {
      ...
      public List<LessonPlanEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfLessonType = CursorUtil.getColumnIndexOrThrow(_cursor, "lessonType");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpLessonType;
            if (_cursor.isNull(_cursorIndexOfLessonType)) {
              _tmpLessonType = null;
            } else {
              _tmpLessonType = _cursor.getString(_cursorIndexOfLessonType);
            }
            ...
            final String _tmpDifficulties;
            if (_cursor.isNull(_cursorIndexOfDifficulties)) {
              _tmpDifficulties = null;
            } else {
              _tmpDifficulties = _cursor.getString(_cursorIndexOfDifficulties);
            }
            ...
            if (_cursor.isNull(_cursorIndexOfBlocksJson)) {
              _tmpBlocksJson = null;
            } else {
            ...
            _item = new LessonPlanEntity(_tmpPlanId,_tmpTitle,_tmpLessonType,_tmpKeyPoints,_tmpDifficulties,_tmpContentMarkdown,_tmpBlocksJson,_tmpTargetClassName,_tmpRelatedKnowledgeNodeId,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public LessonPlanEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new LessonPlanEntity(_tmpPlanId,_tmpTitle,_tmpLessonType,_tmpKeyPoints,_tmpDifficulties,_tmpContentMarkdown,_tmpBlocksJson,_tmpTargetClassName,_tmpRelatedKnowledgeNodeId,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
