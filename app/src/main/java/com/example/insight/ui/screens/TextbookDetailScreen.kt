    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            items(unit.details) { section ->
                val icon = when {
                    section.category.contains("导读") -> Icons.Default.MenuBook
                    section.category.contains("词汇") || section.category.contains("积累") -> Icons.Default.Translate
                    section.category.contains("语法") -> Icons.Default.AutoAwesome
                    section.category.contains("分析") -> Icons.Default.Lightbulb
                    section.category.contains("真题") || section.category.contains("考点") -> Icons.Default.Quiz
    ...
    Column(modifier = Modifier.fillMaxWidth()) {
        Row(verticalAlignment = Alignment.CenterVertically) {
            Icon(
                ...
                tint = if (title.contains("导读")) primaryColor else secondaryColor,
            ...
            Text(
                ...
                color = if (title.contains("导读")) primaryColor else secondaryColor
            )
        }
